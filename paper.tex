...
Prompt-length checks show that even the longest history settings produce prompts well below a 64k context window (max observed \(\sim\)11k characters, \(\sim\)2.2k words), suggesting that truncation is not the main driver of failure in these experiments.
